...
public static partial class S
{
    ...
    { 
        ...
        { Home, new("Home") },
        { HomeBody, new("<p>Welcome to Maple.</p><p>Maple is a HR management tool, it tracks skills proficiencies and individual profiles</p>") },
        ...
        { OrgConfirmDeleteOrg, new("<p>Are you sure you want to delete the org <strong>{{Name}}</strong>?</p><p>This can not be undone.</p>") },
        { OrgMemberInviteEmailHtml, new("<p>Dear <strong>{{InviteeName}}</strong></p><p><strong>{{InvitedByName}}</strong> has invited you to join the org: <strong>{{OrgName}}</strong></p><p><a href=\"{{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}\">Please click this link to verify your email address and join <strong>{{OrgName}}</strong></a></p>") },
        ...
        { ProfileTemplateGuide, new("Tokens: {{Name}}, {{ImageUrl}}, {{Title}}, {{Body}}, {% for skill in Skills %} {{skill}} {% endfor %}, {{GithubUrl}}, {{LinkedInUrl}}") },
        { Required, new("Required") },
        { Skill, new("Skill") },
        { Skills, new("Skills") },
        { StringValidation, new("Invalid string {{Name}}, Min {{Min}}, Max {{Max}}, Regexes {{Regexes}}") },
        { Title, new("Title") },
